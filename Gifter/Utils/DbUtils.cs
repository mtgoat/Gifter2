...
namespace Gifter.Utils
{
    ...
    /// </summary>
    /// It's a class we created in order help simplify some of our database interaction code, particularly with regards to dealing with null values. You might have noticed that the Caption column in the Post table is nullable, so we could use the help.
